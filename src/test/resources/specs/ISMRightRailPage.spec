@objects
   ...
   header-infoicon        xpath         //*[@id="universalCartTimerBannerId"]/div/div/div/div/div
   header-infotext        xpath         //*[@id="universalCartTimerBannerId"]/div/div/div/div/span
...
= Header =
   header-logo:
        ...
        css color contains "rgba(0, 156, 222, 1)"
   ...
   header-infoicon:
        inside screen 60px top
        visible
        width 22px
        aligned horizontally all header-signin 60px
        aligned horizontally all header-language 60px
        aligned horizontally all header-cart 63px
        inside header-subnav 6px top, 68px left, 1590px right , 7px bottom
        aligned horizontally centered header-subnav 46px
        left-of header-signin 1315px
        left-of header-language 1416px
        left-of header-cart 1493px
        height 27px
        css font-weight contains "300"
        css color contains "rgba(255, 255, 255, 1)"
